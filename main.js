    ...
    $(document).ready(function () {
        $('img.header__burger__btn').on('click', function (e) {
            e.preventDefault();
            $('.hero__left-sideBar').addClass('active');
        });
    
        $('.x_icon').on('click', function (e) {
            e.preventDefault();
            $('.hero__left-sideBar').removeClass('active');
        });
    
        // Sidebar tashqarisiga bosilganda yopish
        $(document).on('click', function (e) {
            if (!$(e.target).closest('.hero__left-sideBar, .header__burger__btn').length) {
                $('.hero__left-sideBar').removeClass('active');
            }
        });
    });
    ...
    $('img.header__burger__btn').on('click', function(e){
        e.preventDefault();
        $('.hero__left-sideBar').addClass('show')
    })

    $('.x_icon').on('click', function(e){
        e.preventDefault();
        $('.right_hero').addClass('show')
    })

    $('.x_icon').on('click', function(e){
        e.preventDefault();
        $('.right_hero').removeClass('show')
    })

    $('.x_icon').on('click', function(e){
        e.preventDefault();
        $('.hero__left-sideBar').removeClass('show')
    })
